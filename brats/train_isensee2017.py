...
from unet3d.model import isensee2017_model, unet_attention
from unet3d.training import load_old_model, train_model
from unet3d.losses import focal_tversky_loss
...
def main(overwrite=False):
    ...
    if not overwrite and os.path.exists(config["model_file"]):
        ...
        model = unet_attention.unet(input_shape=config["input_shape"], n_labels=config["n_labels"],
                                  initial_learning_rate=config["initial_learning_rate"])        
        print(model.summary())
